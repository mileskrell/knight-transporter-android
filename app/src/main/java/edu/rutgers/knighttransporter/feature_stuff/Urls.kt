...
const val commonParams = "f=geojson&geometry=%7B%22xmin%22%3A$xMin%2C%22ymin%22%3A$yMin%2C%22xmax%22%3A$xMax%2C%22ymax%22%3A$yMax%7D"
...
const val buildingsPath = "Rutgers_University_Buildings/FeatureServer/0/query?$commonParams&outFields=$BUILDING_NAME%2C$BUILDING_NUMBER%2C$LATITUDE%2C$LONGITUDE"
